...
Design and implement a class called Spheres that contains instance data that represent a sphere’s diameter.
-   Define a Spheres constructor to accept and initialize the diameter.
...
-   Create a driver class (main class) called MultiSphere, whose main method instantiates and updates several Spheres objects.
